...
export default function Jumbotron() {
  ...
  <div className="grid lg:grid-cols-2 justify-center items-center p-32">
    <div className="flex flex-col gap-8">
      ...
      <a href="/"><button className='text-white text-xl uppercase bg-blue-600 w-fit px-10 py-4 opacity-80 font-bold hover:bg-transparent hover:dark:bg-transparent hover:text-blue-600 hover:dark:text-blue-600 rounded-tr-3xl rounded-bl-3xl hover:ring-2 ring-blue-600'>Contact us</button></a>
    </div>
    <div className="">
